                                    ...
                                    <div className="grid grid-cols-3 gap-8 p-8 text-start">
                                        ...
                                        <div className="col-span-1 border-s border-darkgray ps-8">
                                            ...
                                            <ul className="space-y-4">
                                                <li className="flex items-start space-x-3 rtl:space-x-reverse">
                                                    ...
                                                    <span className="text-sm text-slategray hover:text-purewhite transition-colors duration-300 ease-in-out">+966 11 XXX XXXX</span>
                                                </li>
                                                <li className="flex items-start space-x-3 rtl:space-x-reverse">
                                        ...
                                        <div className="col-span-1 border-s border-darkgray ps-8">
                                            ...
                                            <ul className="space-y-3">
                                                <li>
                                                    <Link href="#" className="flex items-center space-x-2 rtl:space-x-reverse text-sm text-slategray hover:text-purewhite transition-colors duration-300 ease-in-out">
                                                        <span>LinkedIn</span>
                            ...
                            {isCompanyHovered && (
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="text-sm text-slategray hover:text-purewhite transition-colors duration-300 ease-in-out">+966 11 XXX XXXX</p>
                                    ...
                                    <div>
                                        ...
                                        <Link href="#" className="block text-sm text-slategray hover:text-purewhite transition-colors duration-300 ease-in-out mb-2">LinkedIn</Link>
                                        <Link href="#" className="block text-sm text-slategray hover:text-purewhite transition-colors duration-300 ease-in-out mb-6">Twitter / X</Link>
